...
# Misc :)
export LESS="--long-prompt --raw-control-chars --squeeze-blank-lines -\
-HILITE-UNREAD"
...
# alias mysqlstart='sudo /opt/local/bin/mysqld_safe5 --verbose'
...
[[ -s $HOME/.autojump ]] && source $HOME/.autojump

# MacPorts Installer addition on 2009-08-28_at_16:16:14: adding an appropriate PATH variable for use with MacPorts.
